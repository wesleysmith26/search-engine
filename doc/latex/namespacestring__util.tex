...
{\em hex\-Str} & \hyperlink{class_the}{The} string to convert.  How much of the string to analyze. \hyperlink{class_the}{The} value -\/1 (the default) will tell the function to read until there are no more valid hexadecimal digits. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{class_the}{The} value of the string as an integer. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em string} & \hyperlink{class_the}{The} string to search in. \\
\hline
{\em search} & \hyperlink{class_the}{The} sequence of characters to skip. \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em string} & \hyperlink{class_the}{The} string to search. \\
\hline
{\em ch} & \hyperlink{class_the}{The} character to search for. \\
\hline
{\em offset} & \hyperlink{class_the}{The} offset in the string to begin the search from. \hyperlink{class_the}{The} default (-\/1) will begin the search at the end of the string. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{class_the}{The} offset of the found character, or -\/1 if not found. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em open\-Symbol} & \hyperlink{class_the}{The} opening symbol. \\
\hline
{\em close\-Symbol} & \hyperlink{class_the}{The} closing symbol that we are looking for. \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em Text} & \hyperlink{class_the}{The} text to have blank lines removed from. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
{\em ch} & \hyperlink{class_the}{The} character to search for. \\
\hline
{\em size} & \hyperlink{class_the}{The} size of the search string. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em string\-To\-Search} & \hyperlink{class_the}{The} string to search. \\
\hline
{\em string\-To\-Search\-Length} & \hyperlink{class_the}{The} length of the string being searched. \\
\hline
{\em search\-String} & \hyperlink{class_the}{The} sequence of characters to search for. \\
\hline
{\em search\-String\-Length} & \hyperlink{class_the}{The} length of the sequence string. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{class_the}{The} index into the string that the character was found. Returns the length of the string if not found. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em str} & \hyperlink{class_the}{The} string to review. \\
\hline
{\em maxlen} & \hyperlink{class_the}{The} maximum length of the string to scan. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
