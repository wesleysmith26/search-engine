...
Appends a new child node. \hyperlink{class_the}{The} appended child becomes the last child. 
\begin{DoxyParams}{Parameters}
...
Prepends a new child node. \hyperlink{class_the}{The} prepended child becomes the first child, and all existing children are moved one position back. 
\begin{DoxyParams}{Parameters}
