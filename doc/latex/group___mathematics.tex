...
{\em actual} & \hyperlink{class_the}{The} value being reviewed. \\
\hline
{\em expected} & \hyperlink{class_the}{The} expected value to compare against. \\
\hline
{\em delta} & \hyperlink{class_the}{The} tolerance of how different the values can be. \hyperlink{class_the}{The} larger the delta, the higher precision used in the comparison. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em left} & \hyperlink{class_the}{The} value being reviewed. \\
\hline
{\em right} & \hyperlink{class_the}{The} other value to compare against. \\
\hline
{\em delta} & \hyperlink{class_the}{The} tolerance of how different the values can be. \hyperlink{class_the}{The} larger the delta, the higher precision used in the comparison. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em int\-Val} & \hyperlink{class_the}{The} integer value to convert to a boolean. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{class_the}{The} boolean equivalent of the integer. 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{class_the}{The} quotient of the division operation, or zero if one of the values was invalid. 
\end{DoxyReturn}
\begin{DoxyNote}{Note}
